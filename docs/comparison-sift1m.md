...
| id | workload | sm-sift-perf-0923 qps | qd-sift-perf-0923 qps | ratio | sm-sift-perf-0923 p50/p99 | qd-sift-perf-0923 p50/p99 | recall@10 | notes |
|---|---|--:|--:|--:|--:|--:|--:|---|
| W0 | d=4 floor: graph traversal with the distance taken out | 4,452 | 3,272 | 1.36x | 221 µs / 269 µs | 305 µs / 373 µs | - | 1.36x is 1.93x less work per query x 0.65x cores busy during the row (0.69 against 1.06) x 1.00x clock x 1.08x counted on-CPU share: the middle term is occupancy, not search speed |
| W3 | search, fp32, single query | 1,748 | 1,936 | 0.90x | 587 µs / 705 µs | 519 µs / 722 µs | 0.9877 / 0.9873 |  |
| W4 | search, saturating (closed loop) | 23,477 | 10,501 | 2.24x | 2.73 ms / 3.06 ms | 6.13 ms / 7.06 ms | 0.9877 / 0.9873 | 2.24x is 1.57x less work per query x 1.37x cores busy during the row (7.53 against 5.48) x 1.00x clock x 1.04x counted on-CPU share: the middle term is occupancy, not search speed |
| W4-sat50 | search, fixed rate at 50% of saturation (open loop) | 5,176 | 5,176 | offered | 487 µs / 1.12 ms | 760 µs / 1.69 ms | 0.9877 / 0.9873 |  |
| W4-sat70 | search, fixed rate at 70% of saturation (open loop) | 7,246 | 7,246 | offered | 463 µs / 846 µs | 912 µs / 1.86 ms | 0.9877 / 0.9873 |  |
| W4-sat90 | search, fixed rate at 90% of saturation (open loop) | 9,315 | 9,315 | offered | 500 µs / 1.07 ms | 1.05 ms / 2.17 ms | 0.9877 / 0.9873 |  |
| W5 | search batched (16 distinct dataset queries per request) | 23,742 | 4,854 | 4.89x | 1.34 ms / 1.51 ms | 6.57 ms / 7.21 ms | 0.9877 / 0.9873 | per-batch latency (16 queries/request); queries: dataset, random-sample 4.89x is 1.35x less work per query x 3.58x cores busy during the row (7.05 against 1.97) x 1.00x clock x 1.01x counted on-CPU share: the middle term is occupancy, not search speed |
| W6 | quantized: scalar | 4,220 | 4,779 | - | 461 µs / 646 µs | 416 µs / 537 µs | 0.9874 / 0.9644 | recall unequal: 0.9874 vs 0.9644; §7.4 compares at equal recall; rescore pools differ (decisions §5) |
| W7 | quantized: binary + oversampling | 3,528 | 4,678 | - | 570 µs / 767 µs | 421 µs / 560 µs | 0.0643 / 0.0423 | recall below the usable floor: 0.0643 and 0.0423, both under 0.50 — this row characterises the encoding, not the engines |
| W8 | quantized: PQ | 3,048 | 4,174 | - | 673 µs / 815 µs | 473 µs / 588 µs | 0.9857 / 0.6979 | recall unequal: 0.9857 vs 0.6979; §7.4 compares at equal recall; rescore pools differ (decisions §5) |
| W9 | exact / brute force | 191 | 145 | 1.31x | 37.76 ms / 66.51 ms | 54.85 ms / 71.89 ms | - | 1.31x is 0.77x less work per query x 1.70x cores busy during the row (6.94 against 4.09) x 1.00x clock: the middle term is occupancy, not search speed |
| W10-ef32 | recall control, ef=32 (latency only) | 40,655 | 21,550 | 1.89x | 188 µs / 254 µs | 349 µs / 656 µs | 0.9075 / 0.8990 | sm-sift-perf-0923: -n 100000 (2x the table's 50000) |
| W10-ef64 | recall control, ef=64 (latency only) | 31,609 | 16,050 | 1.97x | 249 µs / 315 µs | 478 µs / 834 µs | 0.9629 / 0.9600 | sm-sift-perf-0923: -n 100000 (2x the table's 50000) |
| W10-ef128 | recall control, ef=128 (latency only) | 20,860 | 9,853 | 2.12x | 385 µs / 479 µs | 798 µs / 1.30 ms | 0.9877 / 0.9873 | 2.12x is 1.57x less work per query x 1.31x cores busy during the row (6.72 against 5.14) x 1.00x clock x 1.03x counted on-CPU share: the middle term is occupancy, not search speed |
| W10-ef256 | recall control, ef=256 (latency only) | 12,272 | 5,699 | 2.15x | 658 µs / 879 µs | 1.41 ms / 2.14 ms | 0.9962 / 0.9969 | 2.15x is 1.44x less work per query x 1.47x cores busy during the row (7.01 against 4.77) x 1.00x clock x 1.02x counted on-CPU share: the middle term is occupancy, not search speed |
| W10-ef512 | recall control, ef=512 (latency only) | 6,748 | 3,148 | 2.14x | 1.19 ms / 1.70 ms | 2.55 ms / 3.75 ms | 0.9984 / 0.9994 | 2.14x is 1.34x less work per query x 1.57x cores busy during the row (7.08 against 4.50) x 1.00x clock x 1.01x counted on-CPU share: the middle term is occupancy, not search speed |
| W6-ef32 | SQ8 recall control, ef=32 (latency only) | 9,130 | 7,845 | - | 218 µs / 276 µs | 248 µs / 327 µs | 0.9078 / 0.8864 | recall unequal: 0.9078 vs 0.8864; §7.4 compares at equal recall; rescore pools differ (decisions §5) |
| W6-ef64 | SQ8 recall control, ef=64 (latency only) | 6,315 | 6,429 | - | 318 µs / 421 µs | 304 µs / 399 µs | 0.9628 / 0.9412 | recall unequal: 0.9628 vs 0.9412; §7.4 compares at equal recall; rescore pools differ (decisions §5) |
| W6-ef128 | SQ8 recall control, ef=128 (latency only) | 4,256 | 4,812 | - | 458 µs / 644 µs | 414 µs / 526 µs | 0.9874 / 0.9644 | recall unequal: 0.9874 vs 0.9644; §7.4 compares at equal recall; rescore pools differ (decisions §5) |
| W6-ef256 | SQ8 recall control, ef=256 (latency only) | 2,930 | 3,255 | - | 696 µs / 841 µs | 622 µs / 720 µs | 0.9959 / 0.9718 | recall unequal: 0.9959 vs 0.9718; §7.4 compares at equal recall; rescore pools differ (decisions §5) |
| W6-ef512 | SQ8 recall control, ef=512 (latency only) | 1,730 | 1,986 | - | 1.18 ms / 1.42 ms | 1.03 ms / 1.18 ms | 0.9980 / 0.9736 | recall unequal: 0.9980 vs 0.9736; §7.4 compares at equal recall; rescore pools differ (decisions §5) |
| W12-sel1 | filtered search, one keyword (~1% of bench12) | 2,575 | 3,839 | 0.67x | 783 µs / 853 µs | 517 µs / 600 µs | 1.0000 |  |
| W12-sel10 | filtered search, any of 10 keywords (~10% of bench12) | 300 | 2,218 | - | 6.79 ms / 7.37 ms | 905 µs / 1.09 ms | 1.0000 / 0.9895 | recall unequal: 1.0000 vs 0.9895; §7.4 compares at equal recall |
| W12-sel1-ef32 | filtered recall control, one keyword, ef=32 (latency only) | 2,575 | 6,506 | 0.40x | 783 µs / 851 µs | 302 µs / 379 µs | 1.0000 / 0.9963 |  |
| W12-sel1-ef64 | filtered recall control, one keyword, ef=64 (latency only) | 2,576 | 5,233 | 0.49x | 783 µs / 856 µs | 378 µs / 453 µs | 1.0000 / 0.9997 |  |
| W12-sel1-ef128 | filtered recall control, one keyword, ef=128 (latency only) | 2,576 | 3,856 | 0.67x | 783 µs / 857 µs | 515 µs / 597 µs | 1.0000 |  |
| W12-sel1-ef256 | filtered recall control, one keyword, ef=256 (latency only) | 2,573 | 2,666 | 0.97x | 784 µs / 856 µs | 746 µs / 847 µs | 1.0000 |  |
| W12-sel1-ef512 | filtered recall control, one keyword, ef=512 (latency only) | 2,570 | 1,748 | 1.47x | 785 µs / 858 µs | 1.14 ms / 1.28 ms | 1.0000 |  |
| W12-sel10-ef32 | filtered recall control, any of 10 keywords, ef=32 (latency only) | 391 | 4,679 | - | 5.15 ms / 5.88 ms | 422 µs / 537 µs | 0.9966 / 0.7993 | recall unequal: 0.9966 vs 0.7993; §7.4 compares at equal recall |
| W12-sel10-ef64 | filtered recall control, any of 10 keywords, ef=64 (latency only) | 301 | 3,370 | - | 6.76 ms / 7.34 ms | 592 µs / 722 µs | 1.0000 / 0.9330 | recall unequal: 1.0000 vs 0.9330; §7.4 compares at equal recall |
| W12-sel10-ef128 | filtered recall control, any of 10 keywords, ef=128 (latency only) | 300 | 2,234 | - | 6.79 ms / 7.36 ms | 898 µs / 1.08 ms | 1.0000 / 0.9895 | recall unequal: 1.0000 vs 0.9895; §7.4 compares at equal recall |
| W12-sel10-ef256 | filtered recall control, any of 10 keywords, ef=256 (latency only) | 299 | 1,411 | 0.21x | 6.80 ms / 7.37 ms | 1.42 ms / 1.72 ms | 1.0000 / 0.9992 |  |
| W12-sel10-ef512 | filtered recall control, any of 10 keywords, ef=512 (latency only) | 299 | 827 | 0.36x | 6.80 ms / 7.42 ms | 2.42 ms / 2.93 ms | 1.0000 / 0.9999 |  |
| W13 | scroll / pagination | 51,166 | 44,525 | 1.15x | 137 µs / 230 µs | 164 µs / 331 µs | - | sm-sift-perf-0923: -n 200000 (4x the table's 50000) qd-sift-perf-0923: -n 100000 (2x the table's 50000) sm-sift-perf-0923: 0.13 ms of the client's 0.14 ms p50 is not server time (12x), so 92% of this row is the load generator and the socket qd-sift-perf-0923: 0.13 ms of the client's 0.16 ms p50 is not server time (5x), so 81% of this row is the load generator and the socket 1.15x is 3.82x less work per query x 0.30x cores busy during the row (1.39 against 4.59) x 1.00x clock x 0.99x counted on-CPU share: the middle term is occupancy, not search speed |
| W11-steady | mixed read/write below the rebuild threshold: search bench2 while 50,000 synthetic points append | 18,276 | 4,503 | - | 436 µs / 562 µs | 1.64 ms / 4.79 ms | - | sm-sift-perf-0923: search covered 11% of the append; append 2,000 points/s qd-sift-perf-0923: search covered 43% of the append; append 2,000 points/s search-during-write; no recall join |
| W11 | mixed read/write: search bench2 while 200,000 synthetic points append (runs last) | 1,817 | 1,870 | - | 3.32 ms / 13.06 ms | 3.67 ms / 13.89 ms | - | sm-sift-perf-0923: search covered 45% of the append; append 3,300 points/s qd-sift-perf-0923: search covered 44% of the append; append 3,300 points/s search-during-write; no recall join |
...
| peak RSS | 5.9 GiB | 5.8 GiB |
| disk read ops | 33 | 49,503 |
| disk write ops | 42,712 | 403,390 |
| disk read bytes | 48.0 KiB | 1.9 GiB |
| disk write bytes | 2.7 GiB | 22.6 GiB |
| *syscall reads (all fds)* | *10,288,890* | *46,245* |
| *syscall writes (all fds)* | *4,889,131* | *10,380,278* |
...
| T3 ANN statistical equivalence | pass | strawmann n=10000 recall@1=0.9954 recall@10=0.9888 [0.9865,0.9907] recall@100=n/a MRDE=2.5524e-4 \| qdrant n=10000 recall@1=0.9937 recall@10=0.9877 [0.9853,0.9897] recall@100=n/a MRDE=3.2991e-4 \| recall@10 CIs overlap — QPS is comparable at this point |
...
| T4 quantization fidelity | pass | sq8/strawmann: \|Δscore\| over common ids n=97414 max=3.244e1 p99.9=1.251e1 p99=5.751e0 p50=1.806e-1 mean=4.564e-1 (rel max=1.988e-1 p99=3.835e-2) (5172 ids not common to both lists) \| Kendall τ vs fp64 oracle = 0.9468 over 10000 queries (0 with <2 common ids excluded) \| quantization_dominance holds |
| T4 quantization fidelity | pass | sq8/qdrant: \|Δscore\| over common ids n=97310 max=1.578e1 p99.9=2.020e0 p99=1.452e0 p50=3.789e-1 mean=4.498e-1 (rel max=7.840e-2 p99=8.905e-3) (5380 ids not common to both lists) \| Kendall τ vs fp64 oracle = 0.9414 over 9999 queries (1 with <2 common ids excluded) \| quantization_dominance holds |

Reached **T4 quantization fidelity**; licenses performance and comparative claims. Conformance hash `d6c2bfd9aa7f1bfc`.

**sm-sift-perf-0923**: §7.1 gate pass, peak system load 24% of one core (all processes, this engine included), measured 2026-09-23. **qd-sift-perf-0923**: §7.1 gate pass, peak system load 22% of one core (all processes, this engine included), measured 2026-09-23.
<!-- END compare-full -->
