...
| id | workload | sm-sift-perf-rel-0908 qps | qd-sift-perf-rel-0908 qps | ratio | sm-sift-perf-rel-0908 p50/p99 | qd-sift-perf-rel-0908 p50/p99 | recall@10 | notes |
|---|---|--:|--:|--:|--:|--:|--:|---|
| W0 | d=4 floor: graph traversal with the distance taken out | 4,064 | 3,265 | 1.24x | 244 µs / 291 µs | 307 µs / 375 µs | - |  |
| W3 | search, fp32, single query | 1,677 | 1,991 | 0.84x | 610 µs / 721 µs | 508 µs / 619 µs | 0.9888 / 0.9874 |  |
| W4 | search, saturating (closed loop) | 22,973 | 10,446 | 2.20x | 2.80 ms / 3.10 ms | 6.16 ms / 7.18 ms | 0.9888 / 0.9874 |  |
| W4-sat50 | search, fixed rate at 50% of saturation (open loop) | 5,246 | 5,246 | offered | 513 µs / 1.38 ms | 778 µs / 1.70 ms | 0.9888 / 0.9874 |  |
| W4-sat70 | search, fixed rate at 70% of saturation (open loop) | 7,343 | 7,344 | offered | 481 µs / 922 µs | 918 µs / 1.85 ms | 0.9888 / 0.9874 |  |
| W4-sat90 | search, fixed rate at 90% of saturation (open loop) | 9,441 | 9,441 | offered | 531 µs / 1.17 ms | 1.06 ms / 2.35 ms | 0.9888 / 0.9874 |  |
| W5 | search batched (16 distinct dataset queries per request) | 23,189 | 4,892 | 4.74x | 1.37 ms / 1.54 ms | 6.54 ms / 7.05 ms | 0.9888 / 0.9874 | per-batch latency (16 queries/request); queries: dataset, random-sample |
| W6 | quantized: scalar | 3,968 | 4,765 | - | 486 µs / 667 µs | 417 µs / 539 µs | 0.9887 / 0.9642 | recall unequal: 0.9887 vs 0.9642; §7.4 compares at equal recall; rescore pools differ (decisions §5) |
| W7 | quantized: binary + oversampling | 3,450 | 4,670 | - | 587 µs / 758 µs | 422 µs / 558 µs | 0.0610 / 0.0423 | recall below the usable floor: 0.0610 and 0.0423, both under 0.50 — this row characterises the encoding, not the engines |
| W8 | quantized: PQ | 3,016 | 4,136 | - | 682 µs / 811 µs | 474 µs / 603 µs | 0.9853 / 0.6959 | recall unequal: 0.9853 vs 0.6959; §7.4 compares at equal recall; rescore pools differ (decisions §5) |
| W9 | exact / brute force | 191 | 146 | 1.31x | 37.79 ms / 69.44 ms | 54.49 ms / 68.02 ms | - |  |
| W10-ef32 | recall control, ef=32 (latency only) | 40,734 | 21,593 | 1.89x | 188 µs / 252 µs | 349 µs / 654 µs | 0.9085 / 0.8992 | sm-sift-perf-rel-0908: -n 100000 (2x the table's 50000) |
| W10-ef64 | recall control, ef=64 (latency only) | 31,458 | 16,006 | 1.97x | 251 µs / 314 µs | 479 µs / 850 µs | 0.9641 / 0.9605 | sm-sift-perf-rel-0908: -n 100000 (2x the table's 50000) |
| W10-ef128 | recall control, ef=128 (latency only) | 20,522 | 9,870 | 2.08x | 392 µs / 487 µs | 796 µs / 1.32 ms | 0.9888 / 0.9874 |  |
| W10-ef256 | recall control, ef=256 (latency only) | 11,786 | 5,711 | 2.06x | 685 µs / 911 µs | 1.40 ms / 2.15 ms | 0.9974 / 0.9969 |  |
| W10-ef512 | recall control, ef=512 (latency only) | 6,467 | 3,148 | 2.05x | 1.24 ms / 1.75 ms | 2.55 ms / 3.74 ms | 0.9995 / 0.9994 |  |
| W6-ef32 | SQ8 recall control, ef=32 (latency only) | 9,027 | 7,759 | - | 221 µs / 280 µs | 251 µs / 332 µs | 0.9079 / 0.8855 | recall unequal: 0.9079 vs 0.8855; §7.4 compares at equal recall; rescore pools differ (decisions §5) |
| W6-ef64 | SQ8 recall control, ef=64 (latency only) | 5,743 | 6,372 | - | 354 µs / 448 µs | 306 µs / 405 µs | 0.9642 / 0.9412 | recall unequal: 0.9642 vs 0.9412; §7.4 compares at equal recall; rescore pools differ (decisions §5) |
| W6-ef128 | SQ8 recall control, ef=128 (latency only) | 4,001 | 4,759 | - | 482 µs / 666 µs | 418 µs / 540 µs | 0.9887 / 0.9642 | recall unequal: 0.9887 vs 0.9642; §7.4 compares at equal recall; rescore pools differ (decisions §5) |
| W6-ef256 | SQ8 recall control, ef=256 (latency only) | 2,833 | 3,243 | - | 721 µs / 840 µs | 624 µs / 721 µs | 0.9973 / 0.9720 | recall unequal: 0.9973 vs 0.9720; §7.4 compares at equal recall; rescore pools differ (decisions §5) |
| W6-ef512 | SQ8 recall control, ef=512 (latency only) | 1,649 | 1,980 | - | 1.24 ms / 1.46 ms | 1.03 ms / 1.18 ms | 0.9995 / 0.9737 | recall unequal: 0.9995 vs 0.9737; §7.4 compares at equal recall; rescore pools differ (decisions §5) |
| W12-sel1 | filtered search, one keyword (~1% of bench12) | 2,571 | 3,828 | 0.67x | 784 µs / 848 µs | 518 µs / 603 µs | 1.0000 |  |
| W12-sel10 | filtered search, any of 10 keywords (~10% of bench12) | 297 | 2,223 | - | 6.84 ms / 7.65 ms | 903 µs / 1.08 ms | 1.0000 / 0.9900 | recall unequal: 1.0000 vs 0.9900; §7.4 compares at equal recall |
| W13 | scroll / pagination | 51,278 | 44,563 | 1.15x | 136 µs / 230 µs | 164 µs / 335 µs | - | sm-sift-perf-rel-0908: -n 200000 (4x the table's 50000) qd-sift-perf-rel-0908: -n 100000 (2x the table's 50000) |
| W11-steady | mixed read/write below the rebuild threshold: search bench2 while 50,000 synthetic points append | 17,775 | 4,518 | - | 447 µs / 582 µs | 1.64 ms / 4.74 ms | - | append 2,000 points/s search-during-write; no recall join |
| W11 | mixed read/write: search bench2 while 200,000 synthetic points append (runs last) | 1,828 | 1,848 | - | 3.31 ms / 13.14 ms | 3.75 ms / 14.22 ms | - | append 3,300 points/s search-during-write; no recall join |
...
| | sm-sift-perf-rel-0908 | qd-sift-perf-rel-0908 |
|---|--:|--:|
| storage on disk | 3.7 GiB | 10.7 GiB |
| peak RSS | 5.5 GiB | 11.9 GiB |
| disk read ops | 48 | 49,092 |
| disk write ops | 44,226 | 397,172 |
| disk read bytes | 64.0 KiB | 1.9 GiB |
| disk write bytes | 2.7 GiB | 22.4 GiB |
| *syscall reads (all fds)* | *8,165,780* | *45,885* |
| *syscall writes (all fds)* | *3,887,855* | *8,119,067* |
| measured via | proc+cgroup | proc+cgroup |

Storage and RSS are end states; the rest are totals over every row. The syscall rows count every descriptor, sockets included, so on a search row they measure the network rather than the disk, and no ratio between them and the disk rows means anything.
...
| T3 ANN statistical equivalence | pass | strawmann n=10000 recall@1=0.9954 recall@10=0.9888 [0.9866,0.9907] recall@100=n/a MRDE=2.5477e-4 \| qdrant n=10000 recall@1=0.9934 recall@10=0.9878 [0.9855,0.9898] recall@100=n/a MRDE=3.3245e-4 \| recall@10 CIs overlap — QPS is comparable at this point |
...
| T4 quantization fidelity | pass | sq8/strawmann: \|Δscore\| over common ids n=97415 max=3.244e1 p99.9=1.251e1 p99=5.751e0 p50=1.806e-1 mean=4.564e-1 (rel max=1.988e-1 p99=3.835e-2) (5170 ids not common to both lists) \| Kendall τ vs fp64 oracle = 0.9467 over 10000 queries (0 with <2 common ids excluded) \| quantization_dominance holds |
| T4 quantization fidelity | pass | sq8/qdrant: \|Δscore\| over common ids n=97233 max=1.217e1 p99.9=2.025e0 p99=1.590e0 p50=4.232e-1 mean=4.982e-1 (rel max=6.321e-2 p99=9.251e-3) (5534 ids not common to both lists) \| Kendall τ vs fp64 oracle = 0.9400 over 10000 queries (0 with <2 common ids excluded) \| quantization_dominance holds |

Reached **T4 quantization fidelity**; licenses performance and comparative claims. Conformance hash `4fba3350dd130749`.

**sm-sift-perf-rel-0908**: §7.1 gate pass, peak system load 24% of one core (all processes, this engine included), measured 2026-09-08. **qd-sift-perf-rel-0908**: §7.1 gate pass, peak system load 23% of one core (all processes, this engine included), measured 2026-09-08.
<!-- END compare-full -->
