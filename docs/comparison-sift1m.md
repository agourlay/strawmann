...
| W11-steady | mixed read/write below the rebuild threshold: search bench2 while 50,000 synthetic points append | 18,276 | 4,503 | - | 436 µs / 562 µs | 1.64 ms / 4.79 ms | - | append 2,000 points/s search-during-write; no recall join |
| W11 | mixed read/write: search bench2 while 200,000 synthetic points append (runs last) | 1,817 | 1,870 | - | 3.32 ms / 13.06 ms | 3.67 ms / 13.89 ms | - | append 3,300 points/s search-during-write; no recall join |
