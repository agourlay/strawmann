...
cmp    rax,rdx
mov    rax,rcx
jbe    10037b0 <sm_dot_f32+0x60>
mov    rax,rcx
or     rax,0x10
cmp    rax,rdx
jbe    1003860 <sm_dot_f32+0x110>
mov    rax,rcx
jmp    100387e <sm_dot_f32+0x12e>
...
mov    rcx,rax
sub    rcx,rdx
jae    100397f <sm_dot_f32+0x22f>
mov    r8d,edx
sub    r8d,eax
and    r8d,0x7
je     1003903 <sm_dot_f32+0x1b3>
nop    DWORD PTR [rax+rax*1+0x0]
vmovss xmm1,DWORD PTR [rsi+rax*4]
vfmadd231ss xmm0,xmm1,DWORD PTR [rdi+rax*4]
inc    rax
dec    r8
jne    10038f0 <sm_dot_f32+0x1a0>
cmp    rcx,0xfffffffffffffff8
ja     100397f <sm_dot_f32+0x22f>
