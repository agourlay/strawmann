cmp    rdx,0x80
jae    1003210 <sm_manhattan_f32+0x30>
...
jmp    1003337 <sm_manhattan_f32+0x157>
vxorps xmm0,xmm0,xmm0
xor    eax,eax
vbroadcastss zmm8,DWORD PTR [rip+0xffffffffffffd1c8]        # 10003e8 <__anon_3724+0x28>
vxorps xmm3,xmm3,xmm3
vxorps xmm6,xmm6,xmm6
vxorps xmm5,xmm5,xmm5
vxorps xmm4,xmm4,xmm4
...
cmp    rax,rdx
mov    rax,rcx
jbe    1003240 <sm_manhattan_f32+0x60>
push   rbp
mov    rbp,rsp
mov    rax,rcx
or     rax,0x10
cmp    rax,rdx
jbe    100334c <sm_manhattan_f32+0x16c>
mov    rax,rcx
jmp    100338a <sm_manhattan_f32+0x1aa>
vbroadcastss zmm8,DWORD PTR [rip+0xffffffffffffd092]        # 10003e8 <__anon_3724+0x28>
...
cmp    rcx,rdx
mov    rcx,rax
jbe    1003360 <sm_manhattan_f32+0x180>
...
mov    rcx,rax
sub    rcx,rdx
jae    1003487 <sm_manhattan_f32+0x2a7>
mov    r8d,edx
sub    r8d,eax
and    r8d,0x3
je     100341a <sm_manhattan_f32+0x23a>
vbroadcastss xmm1,DWORD PTR [rip+0xffffffffffffcfeb]        # 10003e8 <__anon_3724+0x28>
nop    DWORD PTR [rax]
...
inc    rax
dec    r8
jne    1003400 <sm_manhattan_f32+0x220>
cmp    rcx,0xfffffffffffffffc
ja     1003487 <sm_manhattan_f32+0x2a7>
vbroadcastss xmm1,DWORD PTR [rip+0xffffffffffffcfbf]        # 10003e8 <__anon_3724+0x28>
nop    DWORD PTR [rax+0x0]
vmovss xmm2,DWORD PTR [rdi+rax*4]
...
add    rax,0x4
cmp    rdx,rax
jne    1003430 <sm_manhattan_f32+0x250>
vxorps xmm0,xmm0,DWORD BCST [rip+0xffffffffffffcf53]        # 10003e4 <__anon_3724+0x24>
pop    rbp
vzeroupper
ret
cs nop WORD PTR [rax+rax*1+0x0]
