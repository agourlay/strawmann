...
xor    eax,eax
vpbroadcastd zmm5,DWORD PTR [rip+0xffffffffffffe742]        # 10003e0 <__anon_3724+0x20>
vbroadcasti32x4 zmm6,XMMWORD PTR [rip+0xffffffffffffe758]        # 1000400 <__anon_4789+0x10>
vpxor  xmm2,xmm2,xmm2
vpxor  xmm3,xmm3,xmm3
vpxor  xmm1,xmm1,xmm1
vpxor  xmm0,xmm0,xmm0
...
push   rbp
mov    rbp,rsp
vpbroadcastd zmm4,DWORD PTR [rip+0xffffffffffffe5eb]        # 10003e0 <__anon_3724+0x20>
vbroadcasti32x4 zmm5,XMMWORD PTR [rip+0xffffffffffffe601]        # 1000400 <__anon_4789+0x10>
