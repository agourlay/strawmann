cmp    rdx,0x80
jae    10034d0 <sm_euclid_f32+0x30>
...
jmp    10035c7 <sm_euclid_f32+0x127>
vxorps xmm0,xmm0,xmm0
xor    eax,eax
vxorps xmm4,xmm4,xmm4
vxorps xmm7,xmm7,xmm7
...
cmp    rax,rdx
mov    rax,rcx
jbe    1003500 <sm_euclid_f32+0x60>
mov    rax,rcx
or     rax,0x10
cmp    rax,rdx
jbe    10035e0 <sm_euclid_f32+0x140>
mov    rax,rcx
jmp    1003604 <sm_euclid_f32+0x164>
...
mov    rcx,rax
sub    rcx,rdx
jae    1003733 <sm_euclid_f32+0x293>
mov    r8d,edx
sub    r8d,eax
and    r8d,0x7
je     1003687 <sm_euclid_f32+0x1e7>
xchg   ax,ax
...
inc    rax
dec    r8
jne    1003670 <sm_euclid_f32+0x1d0>
cmp    rcx,0xfffffffffffffff8
ja     1003733 <sm_euclid_f32+0x293>
...
add    rax,0x8
cmp    rdx,rax
jne    10036a0 <sm_euclid_f32+0x200>
push   rbp
mov    rbp,rsp
vxorps xmm0,xmm0,DWORD BCST [rip+0xffffffffffffcca3]        # 10003e4 <__anon_3724+0x24>
pop    rbp
vzeroupper
ret
