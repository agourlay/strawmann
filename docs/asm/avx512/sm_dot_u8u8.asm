...
or     rcx,0x40
cmp    rcx,rdx
jbe    1002b40 <sm_dot_u8u8+0x2a0>
mov    rcx,rax
jmp    1002bbe <sm_dot_u8u8+0x31e>
...
mov    r8,rcx
sub    r8,rdx
jae    1002d2c <sm_dot_u8u8+0x48c>
mov    r9d,edx
sub    r9d,ecx
and    r9d,0x7
je     1002c79 <sm_dot_u8u8+0x3d9>
nop    DWORD PTR [rax]
...
inc    rcx
dec    r9
jne    1002c60 <sm_dot_u8u8+0x3c0>
cmp    r8,0xfffffffffffffff8
ja     1002d2c <sm_dot_u8u8+0x48c>
