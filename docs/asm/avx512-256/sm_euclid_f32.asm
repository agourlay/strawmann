cmp    rdx,0x40
jae    100303d <sm_euclid_f32+0x2d>
...
jmp    1003112 <sm_euclid_f32+0x102>
vxorps xmm0,xmm0,xmm0
xor    eax,eax
vxorps xmm4,xmm4,xmm4
vxorps xmm7,xmm7,xmm7
...
vsubps ymm8,ymm10,YMMWORD PTR [rsi+rax*4+0x40]
vfmadd231ps ymm3,ymm8,ymm8
...
vsubps ymm8,ymm9,YMMWORD PTR [rsi+rax*4+0xc0]
...
cmp    rax,rdx
mov    rax,rcx
jbe    1003060 <sm_euclid_f32+0x50>
mov    rax,rcx
or     rax,0x8
cmp    rax,rdx
jbe    1003130 <sm_euclid_f32+0x120>
mov    rax,rcx
jmp    100314f <sm_euclid_f32+0x13f>
...
mov    rcx,rax
sub    rcx,rdx
jae    1003263 <sm_euclid_f32+0x253>
mov    r8d,edx
sub    r8d,eax
and    r8d,0x7
je     10031b7 <sm_euclid_f32+0x1a7>
xchg   ax,ax
...
inc    rax
dec    r8
jne    10031a0 <sm_euclid_f32+0x190>
cmp    rcx,0xfffffffffffffff8
ja     1003263 <sm_euclid_f32+0x253>
...
add    rax,0x8
cmp    rdx,rax
jne    10031d0 <sm_euclid_f32+0x1c0>
push   rbp
mov    rbp,rsp
vxorps xmm0,xmm0,DWORD BCST [rip+0xffffffffffffcfd3]        # 1000244 <__init_array_end+0x244>
pop    rbp
vzeroupper
ret
