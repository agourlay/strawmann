...
cmp    rax,rdx
mov    rax,rcx
jbe    10032e0 <sm_dot_f32+0x60>
mov    rax,rcx
or     rax,0x8
cmp    rax,rdx
jbe    1003390 <sm_dot_f32+0x110>
mov    rax,rcx
jmp    10033ab <sm_dot_f32+0x12b>
data16 data16 data16 cs nop WORD PTR [rax+rax*1+0x0]
...
mov    rcx,rax
sub    rcx,rdx
jae    100348f <sm_dot_f32+0x20f>
mov    r8d,edx
sub    r8d,eax
and    r8d,0x7
je     1003413 <sm_dot_f32+0x193>
nop    WORD PTR [rax+rax*1+0x0]
vmovss xmm1,DWORD PTR [rsi+rax*4]
vfmadd231ss xmm0,xmm1,DWORD PTR [rdi+rax*4]
inc    rax
dec    r8
jne    1003400 <sm_dot_f32+0x180>
cmp    rcx,0xfffffffffffffff8
ja     100348f <sm_dot_f32+0x20f>
