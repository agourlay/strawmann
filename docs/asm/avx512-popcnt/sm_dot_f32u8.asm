...
jmp    10025a7 <sm_dot_f32u8+0x127>
vxorps xmm0,xmm0,xmm0
xor    eax,eax
vxorps xmm4,xmm4,xmm4
vxorps xmm7,xmm7,xmm7
...
cmp    rax,rdx
mov    rax,rcx
jbe    10024e0 <sm_dot_f32u8+0x60>
mov    rax,rcx
or     rax,0x10
cmp    rax,rdx
jbe    10025c0 <sm_dot_f32u8+0x140>
mov    rax,rcx
jmp    10025e4 <sm_dot_f32u8+0x164>
...
mov    rcx,rax
sub    rcx,rdx
jae    100270b <sm_dot_f32u8+0x28b>
mov    r8d,edx
sub    r8d,eax
and    r8d,0x7
je     1002668 <sm_dot_f32u8+0x1e8>
xchg   ax,ax
...
inc    rax
dec    r8
jne    1002650 <sm_dot_f32u8+0x1d0>
cmp    rcx,0xfffffffffffffff8
ja     100270b <sm_dot_f32u8+0x28b>
...
add    rax,0x8
cmp    rdx,rax
jne    1002680 <sm_dot_f32u8+0x200>
pop    rbp
vzeroupper
ret
