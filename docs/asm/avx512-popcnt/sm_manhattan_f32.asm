cmp    rdx,0x80
jae    1003080 <sm_manhattan_f32+0x30>
...
jmp    10031a7 <sm_manhattan_f32+0x157>
vxorps xmm0,xmm0,xmm0
xor    eax,eax
vbroadcastss zmm8,DWORD PTR [rip+0xffffffffffffd2cc]        # 100035c <__anon_3729+0x24>
vxorps xmm3,xmm3,xmm3
vxorps xmm6,xmm6,xmm6
vxorps xmm5,xmm5,xmm5
vxorps xmm4,xmm4,xmm4
...
cmp    rax,rdx
mov    rax,rcx
jbe    10030b0 <sm_manhattan_f32+0x60>
push   rbp
mov    rbp,rsp
mov    rax,rcx
or     rax,0x10
cmp    rax,rdx
jbe    10031bc <sm_manhattan_f32+0x16c>
mov    rax,rcx
jmp    10031fa <sm_manhattan_f32+0x1aa>
vbroadcastss zmm8,DWORD PTR [rip+0xffffffffffffd196]        # 100035c <__anon_3729+0x24>
...
cmp    rcx,rdx
mov    rcx,rax
jbe    10031d0 <sm_manhattan_f32+0x180>
...
mov    rcx,rax
sub    rcx,rdx
jae    10032f7 <sm_manhattan_f32+0x2a7>
mov    r8d,edx
sub    r8d,eax
and    r8d,0x3
je     100328a <sm_manhattan_f32+0x23a>
vbroadcastss xmm1,DWORD PTR [rip+0xffffffffffffd0ef]        # 100035c <__anon_3729+0x24>
nop    DWORD PTR [rax]
...
inc    rax
dec    r8
jne    1003270 <sm_manhattan_f32+0x220>
cmp    rcx,0xfffffffffffffffc
ja     10032f7 <sm_manhattan_f32+0x2a7>
vbroadcastss xmm1,DWORD PTR [rip+0xffffffffffffd0c3]        # 100035c <__anon_3729+0x24>
nop    DWORD PTR [rax+0x0]
vmovss xmm2,DWORD PTR [rdi+rax*4]
...
add    rax,0x4
cmp    rdx,rax
jne    10032a0 <sm_manhattan_f32+0x250>
vxorps xmm0,xmm0,DWORD BCST [rip+0xffffffffffffd057]        # 1000358 <__anon_3729+0x20>
pop    rbp
vzeroupper
ret
cs nop WORD PTR [rax+rax*1+0x0]
