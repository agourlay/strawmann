...
vpmovzxbd zmm20,XMMWORD PTR [rsi+rcx*1+0x20]
...
vpmovzxbd zmm17,XMMWORD PTR [rsi+rcx*1+0x30]
...
vpmovzxbd zmm21,XMMWORD PTR [rsi+rcx*1+0x60]
...
vpmovzxbd zmm16,XMMWORD PTR [rsi+rcx*1+0x40]
vpmaddwd zmm16,zmm16,zmm19
vpmovzxbd zmm17,XMMWORD PTR [rsi+rcx*1+0x70]
...
vpmovzxbd zmm21,XMMWORD PTR [rsi+rcx*1+0xa0]
...
vpmaddwd zmm16,zmm16,zmm19
vpmovzxbd zmm17,XMMWORD PTR [rsi+rcx*1+0xb0]
...
vpmovzxbd zmm21,XMMWORD PTR [rsi+rcx*1+0xe0]
vpaddd zmm14,zmm16,zmm14
vpmaddwd zmm16,zmm21,zmm17
vpaddd zmm4,zmm16,zmm4
vpmovzxbd zmm16,XMMWORD PTR [rsi+rcx*1+0xd0]
vpmaddwd zmm16,zmm16,zmm18
vpaddd zmm9,zmm16,zmm9
vpmovzxbd zmm16,XMMWORD PTR [rsi+rcx*1+0xc0]
vpmaddwd zmm16,zmm16,zmm19
vpmovzxbd zmm17,XMMWORD PTR [rsi+rcx*1+0xf0]
...
cmp    rcx,rdx
mov    rcx,rax
jbe    10027c0 <sm_dot_u8u8+0xb0>
mov    rcx,rax
or     rcx,0x40
cmp    rcx,rdx
jbe    10029b0 <sm_dot_u8u8+0x2a0>
mov    rcx,rax
jmp    1002a2e <sm_dot_u8u8+0x31e>
...
vpmovzxbd zmm20,XMMWORD PTR [rsi+rax*1+0x20]
vpmaddwd zmm16,zmm20,zmm16
vpaddd zmm3,zmm16,zmm3
...
vpmaddwd zmm16,zmm16,zmm18
vpmovzxbd zmm17,XMMWORD PTR [rsi+rax*1+0x30]
vpaddd zmm2,zmm16,zmm2
vpmaddwd zmm16,zmm17,zmm19
vpaddd zmm10,zmm16,zmm10
lea    rcx,[rax+0x40]
...
mov    r8,rcx
sub    r8,rdx
jae    1002b9c <sm_dot_u8u8+0x48c>
mov    r9d,edx
sub    r9d,ecx
and    r9d,0x7
je     1002ae9 <sm_dot_u8u8+0x3d9>
nop    DWORD PTR [rax]
...
inc    rcx
dec    r9
jne    1002ad0 <sm_dot_u8u8+0x3c0>
cmp    r8,0xfffffffffffffff8
ja     1002b9c <sm_dot_u8u8+0x48c>
