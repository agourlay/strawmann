...
jmp    1001d10 <sm_hamming+0x120>
vpxor  xmm4,xmm4,xmm4
xor    eax,eax
vpbroadcastd ymm5,DWORD PTR [rip+0xffffffffffffe623]        # 1000240 <__init_array_end+0x240>
vbroadcasti128 ymm6,XMMWORD PTR [rip+0xffffffffffffe63a]        # 1000260 <__anon_4762+0x10>
vpxor  xmm2,xmm2,xmm2
vpxor  xmm3,xmm3,xmm3
vpxor  xmm1,xmm1,xmm1
vpxor  xmm0,xmm0,xmm0
...
vpxor  ymm8,ymm8,YMMWORD PTR [rdi+rax*8+0x20]
...
or     rax,0x4
cmp    rax,rdx
jbe    1001d21 <sm_hamming+0x131>
mov    rcx,r8
jmp    1001d7f <sm_hamming+0x18f>
push   rbp
mov    rbp,rsp
vpbroadcastd ymm4,DWORD PTR [rip+0xffffffffffffe512]        # 1000240 <__init_array_end+0x240>
vbroadcasti128 ymm5,XMMWORD PTR [rip+0xffffffffffffe529]        # 1000260 <__anon_4762+0x10>
...
popcnt r8,r8
mov    r10,QWORD PTR [rsi+rcx*8+0x28]
xor    r10,QWORD PTR [rdi+rcx*8+0x28]
add    r8,rax
popcnt r10,r10
add    r10,r8
add    r10,r9
...
xor    r8d,r8d
popcnt r8,rax
mov    rax,QWORD PTR [rsi+rcx*8+0x38]
xor    rax,QWORD PTR [rdi+rcx*8+0x38]
popcnt rax,rax
add    rax,r8
add    rax,r10
add    rcx,0x8
