cmp    rdx,0x40
jae    100345d <sm_euclid_f32+0x2d>
...
jmp    1003532 <sm_euclid_f32+0x102>
vxorps xmm0,xmm0,xmm0
xor    eax,eax
vxorps xmm4,xmm4,xmm4
vxorps xmm7,xmm7,xmm7
...
cmp    rax,rdx
mov    rax,rcx
jbe    1003480 <sm_euclid_f32+0x50>
mov    rax,rcx
or     rax,0x8
cmp    rax,rdx
jbe    1003550 <sm_euclid_f32+0x120>
mov    rax,rcx
jmp    100356f <sm_euclid_f32+0x13f>
...
mov    rcx,rax
sub    rcx,rdx
jae    1003683 <sm_euclid_f32+0x253>
mov    r8d,edx
sub    r8d,eax
and    r8d,0x7
je     10035d7 <sm_euclid_f32+0x1a7>
xchg   ax,ax
...
inc    rax
dec    r8
jne    10035c0 <sm_euclid_f32+0x190>
cmp    rcx,0xfffffffffffffff8
ja     1003683 <sm_euclid_f32+0x253>
...
add    rax,0x8
cmp    rdx,rax
jne    10035f0 <sm_euclid_f32+0x1c0>
push   rbp
mov    rbp,rsp
vbroadcastss xmm1,DWORD PTR [rip+0xffffffffffffcbb4]        # 1000244 <__init_array_end+0x244>
