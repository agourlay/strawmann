...
vpmovzxbd ymm6,QWORD PTR [rsi+rcx*1+0x10]
vpmaddwd ymm0,ymm6,ymm0
vpaddd ymm3,ymm0,ymm3
vpmovzxbd ymm0,QWORD PTR [rsi+rcx*1+0x8]
vpmaddwd ymm0,ymm0,ymm1
vpaddd ymm8,ymm8,ymm0
vpmovzxbd ymm0,QWORD PTR [rsi+rcx*1]
vpmaddwd ymm0,ymm0,ymm4
vpaddd ymm15,ymm15,ymm0
vpmovzxbd ymm0,QWORD PTR [rsi+rcx*1+0x18]
...
vpmovzxbd ymm0,QWORD PTR [rsi+rcx*1+0x30]
vpmaddwd ymm0,ymm0,ymm1
vpaddd ymm9,ymm9,ymm0
vpmovzxbd ymm0,QWORD PTR [rsi+rcx*1+0x28]
vpmaddwd ymm0,ymm0,ymm4
vpaddd ymm11,ymm11,ymm0
vpmovzxbd ymm0,QWORD PTR [rsi+rcx*1+0x20]
vpmaddwd ymm0,ymm0,ymm5
vmovdqa ymm1,YMMWORD PTR [rsp+0x60]
vpaddd ymm1,ymm0,ymm1
vmovdqa YMMWORD PTR [rsp+0x60],ymm1
vpmovzxbd ymm0,QWORD PTR [rsi+rcx*1+0x38]
...
vpmovzxbd ymm0,QWORD PTR [rsi+rcx*1+0x78]
vpmaddwd ymm0,ymm0,ymm1
...
vmovdqa ymm2,ymm1
cmp    rcx,rdx
jbe    1002ab4 <sm_dot_u8u8+0x334>
mov    rcx,rax
vmovdqa ymm11,ymm12
jmp    1002b26 <sm_dot_u8u8+0x3a6>
vmovdqa ymm11,ymm12
...
vpmovzxbd ymm6,QWORD PTR [rsi+rax*1+0x10]
vpmaddwd ymm0,ymm6,ymm0
vpaddd ymm3,ymm0,ymm3
vpmovzxbd ymm0,QWORD PTR [rsi+rax*1+0x8]
vpmaddwd ymm0,ymm0,ymm1
vpaddd ymm8,ymm8,ymm0
vpmovzxbd ymm0,QWORD PTR [rsi+rax*1]
vpmaddwd ymm0,ymm0,ymm4
vpaddd ymm15,ymm15,ymm0
vpmovzxbd ymm0,QWORD PTR [rsi+rax*1+0x18]
vpmaddwd ymm0,ymm0,ymm5
vpaddd ymm10,ymm10,ymm0
lea    rcx,[rax+0x20]
add    rax,0x40
...
mov    r8,rcx
sub    r8,rdx
jae    1002c8c <sm_dot_u8u8+0x50c>
mov    r9d,edx
sub    r9d,ecx
and    r9d,0x7
je     1002bd9 <sm_dot_u8u8+0x459>
nop    DWORD PTR [rax]
...
inc    rcx
dec    r9
jne    1002bc0 <sm_dot_u8u8+0x440>
cmp    r8,0xfffffffffffffff8
ja     1002c8c <sm_dot_u8u8+0x50c>
data16 data16 data16 cs nop WORD PTR [rax+rax*1+0x0]
