...
mov    rbp,rsp
cmp    rdx,0x100
jae    1002cf4 <sm_dot_u8i8+0x24>
vpxor  xmm1,xmm1,xmm1
xor    eax,eax
vpxor  xmm2,xmm2,xmm2
vpxor  xmm3,xmm3,xmm3
vpxor  xmm0,xmm0,xmm0
jmp    1002d7c <sm_dot_u8i8+0xac>
vpxor  xmm0,xmm0,xmm0
xor    ecx,ecx
vpxor  xmm3,xmm3,xmm3
vpxor  xmm2,xmm2,xmm2
...
cmp    rcx,rdx
mov    rcx,rax
jbe    1002d10 <sm_dot_u8i8+0x40>
mov    rcx,rax
or     rcx,0x40
cmp    rcx,rdx
jbe    1002d90 <sm_dot_u8i8+0xc0>
mov    rcx,rax
jmp    1002db4 <sm_dot_u8i8+0xe4>
nop    DWORD PTR [rax]
...
mov    r8,rcx
sub    r8,rdx
jae    1002edc <sm_dot_u8i8+0x20c>
mov    r9d,edx
sub    r9d,ecx
and    r9d,0x7
je     1002e29 <sm_dot_u8i8+0x159>
...
inc    rcx
dec    r9
jne    1002e10 <sm_dot_u8i8+0x140>
cmp    r8,0xfffffffffffffff8
ja     1002edc <sm_dot_u8i8+0x20c>
