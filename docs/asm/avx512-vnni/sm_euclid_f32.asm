cmp    rdx,0x80
jae    10031e0 <sm_euclid_f32+0x30>
...
jmp    10032d7 <sm_euclid_f32+0x127>
vxorps xmm0,xmm0,xmm0
xor    eax,eax
vxorps xmm4,xmm4,xmm4
vxorps xmm7,xmm7,xmm7
...
cmp    rax,rdx
mov    rax,rcx
jbe    1003210 <sm_euclid_f32+0x60>
mov    rax,rcx
or     rax,0x10
cmp    rax,rdx
jbe    10032f0 <sm_euclid_f32+0x140>
mov    rax,rcx
jmp    1003314 <sm_euclid_f32+0x164>
...
mov    rcx,rax
sub    rcx,rdx
jae    1003443 <sm_euclid_f32+0x293>
mov    r8d,edx
sub    r8d,eax
and    r8d,0x7
je     1003397 <sm_euclid_f32+0x1e7>
xchg   ax,ax
...
inc    rax
dec    r8
jne    1003380 <sm_euclid_f32+0x1d0>
cmp    rcx,0xfffffffffffffff8
ja     1003443 <sm_euclid_f32+0x293>
...
add    rax,0x8
cmp    rdx,rax
jne    10033b0 <sm_euclid_f32+0x200>
push   rbp
mov    rbp,rsp
vxorps xmm0,xmm0,DWORD BCST [rip+0xffffffffffffcf93]        # 10003e4 <__anon_3727+0x24>
pop    rbp
vzeroupper
ret
