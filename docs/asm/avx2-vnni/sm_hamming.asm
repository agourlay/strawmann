...
vbroadcasti128 ymm6,XMMWORD PTR [rip+0xffffffffffffe63a]        # 1000260 <__anon_4767+0x10>
vpxor  xmm2,xmm2,xmm2
vpxor  xmm3,xmm3,xmm3
vpxor  xmm1,xmm1,xmm1
vpxor  xmm0,xmm0,xmm0
...
vbroadcasti128 ymm5,XMMWORD PTR [rip+0xffffffffffffe529]        # 1000260 <__anon_4767+0x10>
