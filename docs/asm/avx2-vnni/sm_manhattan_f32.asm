cmp    rdx,0x40
jae    1002e8d <sm_manhattan_f32+0x2d>
...
jmp    1002f92 <sm_manhattan_f32+0x132>
vxorps xmm0,xmm0,xmm0
xor    eax,eax
vbroadcastss ymm8,DWORD PTR [rip+0xffffffffffffd3ac]        # 1000248 <__init_array_end+0x248>
vxorps xmm3,xmm3,xmm3
vxorps xmm6,xmm6,xmm6
vxorps xmm5,xmm5,xmm5
vxorps xmm4,xmm4,xmm4
...
cmp    rax,rdx
mov    rax,rcx
jbe    1002ec0 <sm_manhattan_f32+0x60>
push   rbp
mov    rbp,rsp
mov    rax,rcx
or     rax,0x8
cmp    rax,rdx
jbe    1002fa7 <sm_manhattan_f32+0x147>
mov    rax,rcx
jmp    1002fd3 <sm_manhattan_f32+0x173>
vbroadcastss ymm8,DWORD PTR [rip+0xffffffffffffd298]        # 1000248 <__init_array_end+0x248>
...
cmp    rcx,rdx
mov    rcx,rax
jbe    1002fb0 <sm_manhattan_f32+0x150>
...
mov    rcx,rax
sub    rcx,rdx
jae    10030b7 <sm_manhattan_f32+0x257>
mov    r8d,edx
sub    r8d,eax
and    r8d,0x3
je     100304a <sm_manhattan_f32+0x1ea>
vbroadcastss xmm1,DWORD PTR [rip+0xffffffffffffd21d]        # 1000248 <__init_array_end+0x248>
nop    DWORD PTR [rax+rax*1+0x0]
...
inc    rax
dec    r8
jne    1003030 <sm_manhattan_f32+0x1d0>
cmp    rcx,0xfffffffffffffffc
ja     10030b7 <sm_manhattan_f32+0x257>
vbroadcastss xmm1,DWORD PTR [rip+0xffffffffffffd1ef]        # 1000248 <__init_array_end+0x248>
...
add    rax,0x4
cmp    rdx,rax
jne    1003060 <sm_manhattan_f32+0x200>
vbroadcastss xmm1,DWORD PTR [rip+0xffffffffffffd184]        # 1000244 <__init_array_end+0x244>
