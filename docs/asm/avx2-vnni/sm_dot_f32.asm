...
cmp    rax,rdx
mov    rax,rcx
jbe    10033a0 <sm_dot_f32+0x60>
mov    rax,rcx
or     rax,0x8
cmp    rax,rdx
jbe    1003450 <sm_dot_f32+0x110>
mov    rax,rcx
jmp    100346b <sm_dot_f32+0x12b>
data16 data16 data16 cs nop WORD PTR [rax+rax*1+0x0]
...
mov    rcx,rax
sub    rcx,rdx
jae    100354f <sm_dot_f32+0x20f>
mov    r8d,edx
sub    r8d,eax
and    r8d,0x7
je     10034d3 <sm_dot_f32+0x193>
nop    WORD PTR [rax+rax*1+0x0]
vmovss xmm1,DWORD PTR [rsi+rax*4]
vfmadd231ss xmm0,xmm1,DWORD PTR [rdi+rax*4]
inc    rax
dec    r8
jne    10034c0 <sm_dot_f32+0x180>
cmp    rcx,0xfffffffffffffff8
ja     100354f <sm_dot_f32+0x20f>
