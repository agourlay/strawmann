cmp    rdx,0x80
jae    1003050 <sm_euclid_f32+0x30>
...
jmp    1003147 <sm_euclid_f32+0x127>
vxorps xmm0,xmm0,xmm0
xor    eax,eax
vxorps xmm4,xmm4,xmm4
vxorps xmm7,xmm7,xmm7
...
cmp    rax,rdx
mov    rax,rcx
jbe    1003080 <sm_euclid_f32+0x60>
mov    rax,rcx
or     rax,0x10
cmp    rax,rdx
jbe    1003160 <sm_euclid_f32+0x140>
mov    rax,rcx
jmp    1003184 <sm_euclid_f32+0x164>
...
mov    rcx,rax
sub    rcx,rdx
jae    10032b3 <sm_euclid_f32+0x293>
mov    r8d,edx
sub    r8d,eax
and    r8d,0x7
je     1003207 <sm_euclid_f32+0x1e7>
xchg   ax,ax
...
inc    rax
dec    r8
jne    10031f0 <sm_euclid_f32+0x1d0>
cmp    rcx,0xfffffffffffffff8
ja     10032b3 <sm_euclid_f32+0x293>
...
add    rax,0x8
cmp    rdx,rax
jne    1003220 <sm_euclid_f32+0x200>
push   rbp
mov    rbp,rsp
vxorps xmm0,xmm0,DWORD BCST [rip+0xffffffffffffd097]        # 1000358 <__anon_3745+0x20>
pop    rbp
vzeroupper
ret
