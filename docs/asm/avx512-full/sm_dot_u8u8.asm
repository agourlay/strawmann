...
or     rcx,0x40
cmp    rcx,rdx
jbe    1002950 <sm_dot_u8u8+0x240>
mov    rcx,rax
jmp    10029b6 <sm_dot_u8u8+0x2a6>
...
mov    r8,rcx
sub    r8,rdx
jae    1002b2c <sm_dot_u8u8+0x41c>
mov    r9d,edx
sub    r9d,ecx
and    r9d,0x7
je     1002a79 <sm_dot_u8u8+0x369>
...
inc    rcx
dec    r9
jne    1002a60 <sm_dot_u8u8+0x350>
cmp    r8,0xfffffffffffffff8
ja     1002b2c <sm_dot_u8u8+0x41c>
