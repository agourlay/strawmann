...
```
  ...
  search, one at a time         1,699            2,019      0.84x
  saturating                   23,166           14,075      1.65x
  mixed read/write              1,940            2,294          -
  exact                           184              122      1.50x
                                                       queries/second

  sift1m, d=128, euclid — these ratios are this dimension's. Also measured: dbpedia-openai-100K-1536-angular, dbpedia-openai-1m

  at equal recall (§7.4's comparison, not equal ef): 2.14x at recall 0.9887, falling to 1.78x at 0.9993, over 8 anchors

  mixed read/write: [strawmann: search covered 43% of the append; append 3,300 points/s] [qdrant: search covered 37% of the append; append 3,300 points/s] [search-during-write; no recall join]
```
<!-- END compare-table -->
...
<p align="center">
  ...
  <a href="https://agourlay.github.io/strawmann/">agourlay.github.io/strawmann</a>.
...
Rendered pages:
[agourlay.github.io/strawmann](https://agourlay.github.io/strawmann/).
...
Published pages are committed under [`docs/reports/`](docs/reports/) and linked
from [agourlay.github.io/strawmann](https://agourlay.github.io/strawmann/).
The landing page says what each run is, which one the front page quotes, and
...
| [`reports/`](https://agourlay.github.io/strawmann/) | the rendered page for each published run, from the landing page |
