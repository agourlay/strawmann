...
```
  ...
  search, one at a time         1,677            1,991      0.84x
  saturating                   22,973           10,446      2.20x
  mixed read/write              1,828            1,848          -
  exact                           191              146      1.31x
                                                       queries/second
...
| [`bugs.md`](docs/bugs.md) | measurement bugs that produced plausible wrong numbers |
...
| [`comparison-dbpedia-openai-100K-1536-angular.md`](docs/comparison-dbpedia-openai-100K-1536-angular.md) | the same at d=1536, 100K, and the only licensed comparison at that width |
